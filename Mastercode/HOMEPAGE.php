...
<html>
  ...
  <body>
      ...
      <div class="right-section">
        ...
        <div class="drop-down" id="myDropdown">
          <form class="form-container">
            ...
            <button type="submit" formaction="Settings.php" class="btn nav">
              Account
            </button>
            <?php
    ...
    <main class="task-grid">
            ...
            <div class="task-box">
              <div class="task-form">
                ...
                <form action="" method="post">
                    ...
                    <!--description box-->
                     <label>Description<br/>
                     <textarea name="description" rows="10" cols="35" ><?php echo $row['description']?></textarea>
                      </label>
                    <!--Date-->
                    <label for="duedate">Due Date</label>
        ...
        <?php } else { ?>
          <?php
        $query = "select * from task where uID = '$uID' and sID = 1 order by duedate";
        $result = mysqli_query($connect, $query);
        while ($row = mysqli_fetch_assoc($result)) {
        ?>
            <div class="task-preview">
            ...
            <div class="task-box">
              <div class="task-form">
                <!--Stephanie (Edit Task) & Emillio Code (New Task) Here?-->
                    ...
                    <form action="sidupdate.php" method="POST">
                    <input type ="hidden" name="tID" value="<?php echo $row['tID']?>"/>
                    <button type="submit" name = "completed" id="complete" >&#10004; Complete</button>
                    </form>
                    </br>
